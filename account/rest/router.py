...
class HybridRouter(routers.DefaultRouter):
    '''default router can only support ViewSet'''
    ...
    def get_api_root_view(self, api_urls):
        ...
        class APIRoot(views.APIView):
            ...
            def get(self, request, format=None):
                ret = collections.OrderedDict()  # {} # group in section by name
                ...
                api_view_url_keys = api_view_urls.keys()
                # api_view_url_keys.sort() # group in section by name
                for api_view_key in api_view_url_keys:
                    if api_view_key.startswith('-'):
                        continue
